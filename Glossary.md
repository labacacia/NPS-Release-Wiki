...
**Suite Version** — The top-level version identifier for an NPS release as a whole (e.g., `v1.0.0-alpha.19`); distinct from individual sub-protocol versions (NCP v0.12, NWP v0.22, NIP v0.15, NDP v0.13, NOP v0.10) which are tracked per spec document. ([NPS-0 §9](https://github.com/labacacia/NPS-Release/blob/main/spec/NPS-0-Overview.md))
