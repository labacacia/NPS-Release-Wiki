...
**Suite Version** — The top-level version identifier for an NPS release as a whole (e.g., `v1.0.0-alpha.18`); distinct from individual sub-protocol versions (NCP v0.11, NWP v0.21, NIP v0.14, NDP v0.12, NOP v0.9) which are tracked per spec document. ([NPS-0 §9](https://github.com/labacacia/NPS-Release/blob/main/spec/NPS-0-Overview.md))
