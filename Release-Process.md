...
The current latest released suite version is **v1.0.0-alpha.14** (released 2026-06-26). All releases bump the suite-wide version uniformly. There are no partial hotfixes that touch only one repo.
