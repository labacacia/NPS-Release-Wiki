...
**Status:** ✅ Latest published artifact — v1.0.0-alpha.19 (released 2026-09-06)
...
```kotlin
dependencies {
    implementation("com.labacacia.nps:nps-java:1.0.0-alpha.19")
}
```
