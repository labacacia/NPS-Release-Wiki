...
| `spec/NPS-Roadmap.md` | v0.6 | Phase 0–4 roadmap. Phase 0 = foundation; Phase 1 = reference implementation (.NET); Phase 2 = SDK expansion; Phase 3 = production hardening; Phase 4 = ecosystem. |
